// src/components/layout/RightIcons.jsx
...
const RightIcons = ({ isDark, toggleTheme }) => {
  ...
  return (
    <div className={containerClasses}>
      ...
      <div className="flex flex-row md:flex-col gap-1 md:gap-2">
        <button onClick={toggleTheme} className={`${btnBase} hover:bg-white/10 text-zinc-400 hover:text-white`} aria-label="Toggle Theme">
        ...
        <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className={`${btnBase} hover:bg-white/10 text-zinc-400 hover:text-[#00de51] hidden md:flex`} aria-label="Scroll Top">
